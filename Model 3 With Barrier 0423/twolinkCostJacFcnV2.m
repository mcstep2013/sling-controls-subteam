function [Gx, Gmv, Gdmv] = twolinkCostJacFcnV2(stage, x, u, dmv, pvcost)
% twolinkCostJacFcn
...
%       - dmv       Necesarry because we implement constraints in change in
%       input elsewhere. Unused in this function.
...
Gdmv=zeros(length(dmv),1); %Since the cost doesnt depend on change in inputs
