...
% twolinkStateJacFcn
%   [A, B] = twolinkStateJacFcn(x, tau, pvstate)
%
%   This function computes the Jacobian matrices A and B for the two-link
%   robot manipulator. The inputs are the state vector x, the control input
%   vector tau, and the additional parameters pvstate.
%
%   This function was generated by the Symbolic Math Toolbox version 9.3.
%
%   To regenerate this code, use the following script:
%       % Define symbolic variables syms x [4 1] real        % State vector
%       syms tau [2 1] real      % Control input vector syms pvstate [9 1]
%       real  % Additional parameters
%
%       % Compute the derivative of the state vector dxdt =
%       twolinkStateFcn(x, tau, pvstate);
%
%       % Compute the Jacobian matrices [A, B] = deal(jacobian(dxdt,x),
%       jacobian(dxdt,tau));
%
%       % Create a MATLAB function for the Jacobian matrices
%       matlabFunction(A, B, ...
%           'Vars', {x,tau,pvstate}, ...
%           'File', 'twolinkStateJacFcn')
