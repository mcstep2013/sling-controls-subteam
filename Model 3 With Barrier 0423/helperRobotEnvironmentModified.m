classdef helperRobotEnvironmentModified < matlab.graphics.chartcontainer.ChartContainer & ...
    ...
    %       figure("Color", "w");
    %       hPlot = helperRobotEnvironment("Length1", 0.3, "Length2", 0.2);
    %
    %       % Update robot angle positions 
    %       hPlot.Theta1 = pi/2;
    %       hPlot.Theta2 = -pi/2;
    %
    %       % To add a plot for the desired robot states 
    %       hPlot.xf = [pi/4; pi/4];
    ...
    properties
        ...
        Length1 = .3        % Length of link 1
        Length2 = .2        % Length of link 2
        Width = 0.02        % Width of the links
        xf                  % Desired position
        xAtt                % x position of attacker
        yAtt                % y position of attacker
    end
    ...
    methods(Access = protected)
        ...
        function update(obj)
            ...
            %Try to plot the attacker
            plot(obj.xAtt,obj.yAtt,'Color','black','Marker','o','MarkerSize',10);
