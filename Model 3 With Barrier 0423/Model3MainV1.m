...
measure_noise = diag([0.05; 1e-6; 0.005; 0.001]);
...
for k = 1:endK
    ...
    tempVar=[];
    for iter=1:p+1
        x_est_prop = constacc(x_est(:,k), iter*Ts); %this is the estimated position of attacker
        x_est_att = x_est_prop(1); %estimated x of attacker
        y_est_att = x_est_prop(4); %estimated z of attacker
