...
msobj.ManipulatedVariables(1).Min = -7.5;
msobj.ManipulatedVariables(1).Max =  7.5;
msobj.ManipulatedVariables(2).Min = -7.5;
msobj.ManipulatedVariables(2).Max =  7.5;
