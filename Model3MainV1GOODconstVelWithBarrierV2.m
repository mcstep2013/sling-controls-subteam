...
% x0 = [-pi/4; pi/2; 0; 0]; %x0 = [0; pi/4; 0; 0];
% x0Attacker=[0.2; 0.4; pi/2; 0;0;0];%[0.1; 1.0; pi/2; 0; 0.0; 0.0];
% Duration = 3.0; %1.0; % simulation duration (s)
% alpha=0.0;
...
x0 = [-pi/4; pi/2; 0; 0]; %x0 = [0; pi/4; 0; 0];
% x0=[-pi;0;0;0];
x0Attacker=[0.2; 0.2; pi/2; 0;0;0];%[0.1; 1.0; pi/2; 0; 0.0; 0.0];
Duration =5.0; %1.0; % simulation duration (s)
alpha=0.0;
x0_guess  = [0.528; 0.679; 0; 0; 0; 0];
x0_guess2 = [0.01; -0.35; 0; 0];
avoidRadius=0.1; %used for constraint
...
%Tuning attempt 2
%Q_a=[30;30;0;1;1;0.5]; %dodges defender, doesnt get to target
%Q_a=[30;30;0;1.5;1.5;0.1]; %dodges defender, gets closer to target, but no cigar
%Q_a=[30;20;0;1.25;1.25;0.1]; %gets there after a while, but could do better
